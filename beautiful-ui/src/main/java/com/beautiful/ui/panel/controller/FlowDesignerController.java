package com.beautiful.ui.panel.controller;
...
public class FlowDesignerController {
    ...
    @ResponseBody
    public Json listNodeGroup(@RequestBody JSONObject jsonObject, HttpServletRequest request, HttpServletResponse response) {
    ...
    @RequestMapping(value = "/saveDataFlow", method = RequestMethod.POST)
    @ResponseBody
    public Json saveDataFlow(@RequestBody JSONObject jsonObject, HttpServletRequest request, HttpServletResponse response) {
